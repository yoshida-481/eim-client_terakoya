...
import { EIMDocumentsCheckinRendererComponentService } from "./documents-checkin-renderer.component.service";
import { EIMDocumentCreatorComponent } from "app/documents/components/document-creator/document-creator.component";
 ...
 */
@Component({
  selector: "eim-documents-checkin-renderer",
  template: `
    <div class="eim-form-item" style="width: 100%;">
      <div class="eim-form-input">
        <div style="padding-left: 43px; display: flex; align-items: center;">
          <p-checkbox
            *ngIf="
              this.params.data.uploadStatus == 5 ||
              this.params.data.uploadStatus == 2
            "
            [(ngModel)]="checked"
            binary="true"
          ...
          ></p-checkbox>
          <p-checkbox
            *ngIf="this.params.data.uploadStatus == 3"
            name="checkin3"
            [(ngModel)]="checked"
            binary="true"
            disabled="false"
          ...
          ></p-checkbox>
          <span
            *ngIf="this.params.data.uploadStatus == 1"
            class="eim-icon-cancel"
            style="color: #FF0000;"
            pTooltip="{{ toolTipString }}"
          ></span>
          <span
            *ngIf="this.params.data.uploadStatus == 0"
            class="eim-icon-checkin"
            style="color: #0d98ed;"
          ></span>
        </div>
      </div>
...
export class EIMDocumentsCheckinRendererComponent
  implements OnInit, DoCheck, AgRendererComponent
{
  public params: any;
   ...
   */
  clickedCheck() {
    this.documentsCheckinRendererComponentService.checkChanged(
      this.params.data
    );
  }
