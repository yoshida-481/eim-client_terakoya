 ...
 * @example
 *
 *      <eim-workspace-home-widget-my-tasks>
 *      </eim-workspace-home-widget-my-tasks>
 */
@Component({
	selector: 'eim-workspace-home-widget-my-tasks',
	templateUrl: './workspace-home-widget-my-tasks.component.html',
	styleUrls: ['./workspace-home-widget-my-tasks.component.scss'],
	providers: [ {provide: EIMComponent, useExisting: forwardRef(() => EIMWorkspaceHomeWidgetMyTasksComponent)}, ],
	standalone: false,
})
export class EIMWorkspaceHomeWidgetMyTasksComponent implements EIMWorkspaceHomeWidgetComponent {
	...
	public update(): void {
		...
		this.taskService.getMyTaskList(this.localStorageService.getUserId(), this.workspaceId)
