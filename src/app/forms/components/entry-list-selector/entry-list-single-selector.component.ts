...
import { EIMEntryListSingleSelectorComponentService } from "app/forms/components/entry-list-selector/entry-list-single-selector.component.service";
 ...
 * @example
 *	<eim-entry-list-single-selector
 *		[allColumns]="allColumns"
 *		[multiple]="true" [mailFlag]="true">
 *	</eim-entry-list-single-selector>
 */
@Component({
    selector: 'eim-entry-list-single-selector',
    templateUrl: './entry-list-single-selector.component.html',
    styleUrls: ['./entry-list-single-selector.component.css'],
    providers: [{provide: EIMComponent, useExisting: forwardRef(() => EIMEntryListSingleSelectorComponent)},
                {provide: EIMSingleSelectorComponent, useExisting: forwardRef(() => EIMEntryListSingleSelectorComponent)}],
    standalone: false
})
export class EIMEntryListSingleSelectorComponent extends EIMDataGridSingleSelectorComponent implements EIMSelectable {
	...
	/** 表示カラム */
	public columns: any[] = [
   	{field: 'code', headerName: this.translateService.instant("EIM.LABEL_02001"), width: 80},
		{field: 'name', headerName: this.translateService.instant("EIM.LABEL_02002"), width: 160},
	...
	constructor(
			...
			public entryListSingleSelectorComponentService: EIMEntryListSingleSelectorComponentService,
