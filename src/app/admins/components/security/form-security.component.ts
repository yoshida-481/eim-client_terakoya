...
@Component({
    ...
    providers: [
        { provide: EIMComponent, useExisting: forwardRef(() => EIMFormSecurityComponent) }
    ],
    schemas:[CUSTOM_ELEMENTS_SCHEMA],
	standalone: true
})
export class EIMFormSecurityComponent extends EIMSecurityComponent implements OnInit  {
