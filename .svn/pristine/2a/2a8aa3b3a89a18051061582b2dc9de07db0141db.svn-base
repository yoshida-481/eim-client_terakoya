...
/**
 * 自担当タスク情報一覧ウィジェットコンポーネント
 * @example
 *
 *      <eim-workspace-home-widget-scheduled-scope-tasks>
 *      </eim-workspace-home-widget-scheduled-scope-tasks>
 */
@Component({
	selector: 'eim-workspace-home-widget-scheduled-scope-tasks',
	templateUrl: './workspace-home-widget-scheduled-scope-tasks.component.html',
	styleUrls: ['./workspace-home-widget-scheduled-scope-tasks.component.scss'],
	providers: [ {provide: EIMComponent, useExisting: forwardRef(() => EIMWorkspaceHomeWidgetScheduledScopeTasksComponent)}, ],
	standalone: false,
})
export class EIMWorkspaceHomeWidgetScheduledScopeTasksComponent implements EIMWorkspaceHomeWidgetComponent {
	...
	public update(): void {
		...
		this.taskService.getScheduledScopeTaskList(this.workspaceId)
