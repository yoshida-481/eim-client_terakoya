...
/**
 * 遅延タスク情報一覧ウィジェットコンポーネント
 * @example
 *
 *      <eim-workspace-home-widget-delayed-tasks>
 *      </eim-workspace-home-widget-delayed-tasks>
 */
@Component({
	selector: 'eim-workspace-home-widget-delayed-tasks',
	templateUrl: './workspace-home-widget-delayed-tasks.component.html',
	styleUrls: ['./workspace-home-widget-delayed-tasks.component.scss'],
	providers: [ {provide: EIMComponent, useExisting: forwardRef(() => EIMWorkspaceHomeWidgetDelayedTasksComponent)}, ],
	standalone: false,
})
export class EIMWorkspaceHomeWidgetDelayedTasksComponent implements EIMWorkspaceHomeWidgetComponent {
	...
	public update(): void {
		...
		this.taskService.getDelayedTaskList(this.workspaceId)
