import { Component, ViewChildren, OnInit, SimpleChanges, Input, EventEmitter, Output, QueryList, CUSTOM_ELEMENTS_SCHEMA } from '@angular/core';
import { TranslateModule, TranslatePipe, TranslateService } from '@ngx-translate/core';

import { EIMDialogComponent } from 'app/shared/components/dialog/dialog.component';
import { EIMObjectEditorDialogManagerComponentService, EIMDialogManagerComponentInfo, dialogName } from './dialog-manager.component.service';
...
@Component({
    selector: 'eim-object-editor-dialog-manager',
...
export class EIMObjectEditorDialogManagerComponent {
