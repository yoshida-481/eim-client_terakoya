...
import { EIMContentsAttributeTypeLayoutDomain } from 'app/admins/shared/domains/contents-attribute-type-layout.domain';

/**
 * 文書管理の属性ドメインサービス.
 */
@Injectable()
export class EIMAdminsAttributeDomainService extends EIMAttributeService {
