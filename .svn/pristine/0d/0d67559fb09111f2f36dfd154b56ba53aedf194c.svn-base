...
import { EIMRichTextInputFormItemComponent } from "./rich-text-input-form-item.component";

export interface EIMRichTextInputFormItemComponentDomain extends EIMInputFormItemComponentDomain {

};

/**
 * リッチテキスト入力フォームコンポーネントサービス
 * @see {@link EIMInputFormItemComponentService}
 */
@Injectable()
export class EIMRichTextInputFormItemComponentService extends EIMInputFormItemComponentService {
	...
	public override getComponent(): Type<EIMInputFormItemComponent> {
		return EIMRichTextInputFormItemComponent;
	};
	...
	public override visibleFunction(inputFormItem: EIMInputFormItemDomain): boolean {
		...
		if (inputFormItem.uiControlId === 'uIControlRichText') {
			return true;
		}
		return false;
	};
	 ...
	 * @param inputFormItem 入力フォーム情報
	 */
	public override initializeComponent(inputFormItemComponent: EIMRichTextInputFormItemComponent, inputFormItem: EIMInputFormItemDomain): void {
	 ...
	 */
	public override createInputFormDomain(inputFormItemComponent: EIMRichTextInputFormItemComponentDomain): EIMInputFormItemDomain {
		let inputFormItem = super.createInputFormDomain(inputFormItemComponent);

		inputFormItem.uiControlId = 'uIControlRichText';
